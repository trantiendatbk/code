...
class Affine_Cipher extends Component {
    constructor(props) {
        super(props)
    ...
    Cryp = () => {
        ...
        i.forEach(element => {
            ...
            let convert = (index* parseInt(this.state.key1)+parseInt(this.state.key2)) % 26 + 97
    ...
    render() {
        return (
            <View>
                ...
                <Text>
                    Key co dang: K(first param, second param)
                </Text>
                <TextInput
                    style={{
                        fontSize: 20,
                    ...
                    placeholder="Nhap first param "
                    placeholderTextColor="#B1B1B1"
                    returnKeyType="next"
                    keyboardType='numeric'
                    textContentType="emailAddress"
                    value={this.state.key}
                    onChangeText={key1 => this.setState({ key1 })}
                />
                <TextInput
                    style={{
                        fontSize: 20,
                    ...
                    placeholder="Nhap second param "
                    placeholderTextColor="#B1B1B1"
                    returnKeyType="next"
                    keyboardType='numeric'
                    textContentType="emailAddress"
                    value={this.state.key}
                    onChangeText={key2 => this.setState({ key2 })}
                />
